...
|---|
|- Registro de patente de aplicación: $251.00 MX |
|- Scrum Team: 4 programadores (2100 x 4) x 12 semanas: $100,800.00 MX |
|- Registro de nombres ante IMPI: $8460.00 MX |
|-  ___Costo total___ : $109,511.00 MX |
...
|Supuestos|
|---|
|Se espera que los usuarios tengan conocimiento previo del manejo de plataformas o aplicaciones con un funcionamiento similar para su mejor y más rápida comprensión de la misma.|

|Restricciones|
|---|
|El proyecto debe estar terminado en su totalidad dentro del plazo establecido y sin tener a necesidad de requerir más presupuesto del previamente establecido.|
